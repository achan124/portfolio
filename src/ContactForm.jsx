...
export function ContactForm() {
    ...
    return (
        <>
            <h2 id="contact" className="mt-5 pt-5">Send a Message!</h2>
            <div className="mb-5 pb-5">
                <form ref={form} onSubmit={sendEmail} className='d-flex flex-column p-2 mt-4 contactForm'>
                    ...
                    <div className='d-flex justify-content-end'>
                        <input type="submit" value="Send" className='mt-4 formSubmitButton'/>
                    </div>
                </form>
